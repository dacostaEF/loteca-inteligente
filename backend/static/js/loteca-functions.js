...
const jogosMap = {
    ...
    4: { csv: 'Atletico-MG_vs_Corinthians.csv', casa: 'Atletico-MG', fora: 'Corinthians' },
    5: { csv: 'Atletico-Madrid_vs_Osasuna.csv', casa: 'Atletico Madrid', fora: 'Osasuna' },
    6: { csv: 'Barcelona_vs_Real-Madrid.csv', casa: 'Barcelona', fora: 'Real Madrid' },
    7: { csv: 'Juventus_vs_Inter.csv', casa: 'Juventus', fora: 'Inter' },
